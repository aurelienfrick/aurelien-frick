...
<strong style="min-width: 80px; flex-shrink: 0;">20/07/26</strong>
    <span>
      ...
      out in <I>Neuropsychology</i> from my previous postdoctoral position at the GIGA-CRC Imaging Human (Liège, Belgium) with Anaïs Servais (lead author), François Meyer, Christine Bastin (Université of Liège) and Emma Delhaye (University of Lisboa).
      </span>
    </div>
...
<div style="margin-top: 10px; text-align: center;">
  ...
  <div style="display: inline-block; width: 220px; vertical-align: top;">
    <img src="photos_with_Paulo_CDS.jpeg"
         style="width: 320px; height: auto; border-radius: 8px;" />
    <div style="font-size: 0.85em; color: #666; font-style: italic; margin-top: 6px;">
      With Paulo at CDS 2026 (credit: Jesse Niebaum)
         </div>
    </div>
  ...
  <div style="display: flex; align-items: flex-start; gap: 15px; line-height: 1.6;">
<strong style="min-width: 80px; flex-shrink: 0;">09/02/26</strong>
    <span>
  ...
  <div style="display: flex; align-items: flex-start; gap: 15px; line-height: 1.6;">
<strong style="min-width: 80px; flex-shrink: 0;">30/01/26</strong>
    <span>
